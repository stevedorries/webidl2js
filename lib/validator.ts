...
import { validationError as error } from "./error.ts";;

export interface Definitions {
  all: any;
  unique: Map<any, any>;
  partials: Map<any, any>;
  duplicates: Set<any>;
  mixinMap: Map<any, any>;
  cache: {
      typedefIncludesDictionary: WeakMap<any, any>;
      dictionaryIncludesRequiredField: WeakMap<any,any>;
  };
};
...
function groupDefinitions(all): Definitions {
